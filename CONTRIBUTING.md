...
- **Adapters** (in Rust, `crates/pluk-adapters/src/`) — MCP server, Redis, SSH, and the SQL family. Linear, Sentry, and Slack still load for integrations already saved, but new ones connect through the MCP server adapter
