...
final class ConnectionStore {
    ...
    private func migrate() {
        ...
        CREATE TABLE IF NOT EXISTS connections (
            ...
            ssh_auth_type TEXT DEFAULT 'key', ssh_key_path TEXT, ssh_password TEXT,
        ...
        let alters = [
            ...
            "ALTER TABLE connections ADD COLUMN ssh_auth_type TEXT DEFAULT 'key'",
    ...
    private func parse(_ stmt: OpaquePointer?) -> Connection? {
        ...
        return Connection(
            ...
            sshAuthType: SSHAuthType(rawValue: str(14) ?? "key") ?? .key,
